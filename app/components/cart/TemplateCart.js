...
export class TemplateCart {
  ...
  getTemplateCartOrder(summary, countItems, { name, phone, email, address, note }) {
    return `
      <div class="container has-margin-top-30 has-padding-bottom-35" style="max-width: 835px;">
              ...
              <div class="columns is-multiline" style="margin: 0;">
                ...
                <div class="column is-12">
                  <div class="field has-margin-bottom-10 animated fadeIn faster"
                    ...
                    <label class="label has-text-grey has-margin-left-25">Note</label>
                    <div class="control">
                      <textarea class="textarea order-field is-full-width is-size-6 has-text-weight-bold has-background-light" 
                        ...
                        data-order="note">${note ? note : ''}</textarea>
                    </div>
                  </div>
                </div>
              </div>
  ...
  getTemplateCartSummary(count, total, withClearBtn = true) {
    return `
      <div class="column cart-total flex flex-row align-items-center ${withClearBtn ? 'justify-space-between' : 'justify-flex-end'} has-padding-15 has-margin-bottom-10">
        ${withClearBtn
